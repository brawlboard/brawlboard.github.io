...
// var vidID = "JC58nqBVils";
// var myID = "UCUNbognrXqUWzJOtrK8YP2A";

var channelcount = 28;

//Default Name
var chanName = "Unknown";
...
//Background Color
var bgColor = "";
var bgImg = "https://yt3.ggpht.com/-UojVTXXFUmQ/AAAAAAAAAAI/AAAAAAAAAAA/r2bMFQbWHv4/s360-c-k-no-mo-rj-c0xffffff/photo.jpg";

$('body').css("background", bgColor);
$('body').css("background-image : url", bgImg);

$(document.body).addClass('bgSize');
